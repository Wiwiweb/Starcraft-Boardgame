...
public class PlanetPosition {
	...
	public PlanetPosition plusCardinal(Cardinal c) {
		int plusX = 0, plusY = 0;
		switch (c) {
	        case NORTH: plusY = -1;  break;
	        case EAST:  plusX = 1;  break;
	        case SOUTH: plusY = 1; break;
	        case WEST:  plusX = -1; break;
	        default: throw new IllegalStateException("This should never happen: " + this + " has no point.");
		}
